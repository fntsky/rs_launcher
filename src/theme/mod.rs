...
fn dark_theme() -> ThemeDTO {
    ThemeDTO {
        ...
        mode: "dark".into(),
        vars: HashMap::from([
            ("--bg-primary".into(), "#1e1e22".into()),
            ("--bg-secondary".into(), "#2a2a30".into()),
            ("--bg-hover".into(), "#3a3a42".into()),
            ("--bg-selected".into(), "#2a3a5a".into()),
            ("--text-primary".into(), "#e0e0e0".into()),
            ("--text-secondary".into(), "#6a6a72".into()),
            ("--text-hint".into(), "#585860".into()),
            ("--accent".into(), "#4a90d9".into()),
            ("--divider".into(), "#3a3a42".into()),
        ]),
    }
}
