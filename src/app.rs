...
impl LauncherApp {
    pub fn new(_cc: &eframe::CreationContext<'_>, hotkey_manager: HotKeyManager, tray_manager: TrayManager) -> Self {
        Self {
            visible: false,
            hotkey_manager,
            tray_manager,
                ...
                ui.vertical_centered(|ui| {
                    ...
                    let response = ui.add(
                        egui::TextEdit::singleline(&mut self.search_text)
                            .hint_text(egui::RichText::new("Type to search...").color(egui::Color32::from_rgb(120, 120, 120)))
                            .desired_width(540.0)
