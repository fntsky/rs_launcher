/**
 * RS Launcher iframe SDK type declarations for plugin authors.
 * The actual runtime SDK is injected by the main window via srcdoc.
 * Plugins only need this file for type-checking their own code.
 */
